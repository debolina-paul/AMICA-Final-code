...
collection_datatosync2 = db["data to sync2"]
...
def total():
	...
	print("connecting user " + get_email)
	print("data processing ongoing")
	if get_email == "paul.debolina2009@gmail.com":
		name = "Debolina Paul"
		age = "32"
		city = "Antibes"
		country = "France"
	...
	elif get_email == "datta.soumyakanti@gmail.com":
		name = "Soumya Kanti Datta"
		age = "33"
		city = "Tallinn"
		country = "Estonia"
		data = collection_datatosync2.find_one({},{'_id': False})
		json_data = data
		json_data["name"] = name
		json_data["age"] = age
		json_data["city"] = city
	...
	print(json.loads(json_util.dumps(json_data)))
